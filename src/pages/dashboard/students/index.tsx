  ...
  return (
    ...
    <div className='grid justify-items-stretch'>
      ...
      <section className='flex w-full justify-between my-4'>
        ...
        <a href={'/dashboard/students/add_student'} className='bg-[#00AE9A] bg-opacity-70 hover:bg-opacity-100 border rounded-md py-4 px-4 flex items-center justify-center text-center font-bold'> <PlusIcon className='w-4 mr-2' /> Add student</a>
      </section>
      <section>
