        ...
        <header className="bg-white shadow-md dark:bg-gray-800">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 p-6 bg-white dark:bg-gray-800">
            ...
            <StatCard
              ...
              icon={<ChartBarIcon className="h-6 w-6 text-orange-600 dark:text-orange-400" />}
            />
          </div>
        </header>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="mt-3 sm:mt-0 inline-flex items-center justify-center rounded-md bg-purple-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 dark:bg-purple-700 dark:hover:bg-purple-800"
            >
      ...
      >
        {toDelete ? (
          <>
            ...
            <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                type="button"
                className="inline-flex w-full justify-center rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 dark:bg-red-700 dark:hover:bg-red-800 sm:ml-3 sm:w-auto"
                onClick={() => {
                  /* deleteStudent() */
                }}
              >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                type="button"
                className="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 dark:bg-gray-800 dark:text-white dark:ring-gray-600 dark:hover:bg-gray-700 sm:mt-0 sm:w-auto"
          ...
          <>
            ...
            <div className="p-4">
              <h2 className="text-lg font-medium text-gray-900 dark:text-white">Edit Student</h2>
              <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Update student information</p>
