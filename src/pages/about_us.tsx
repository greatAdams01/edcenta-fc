        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 items-start gap-x-8 gap-y-16 sm:gap-y-24 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          ...
          <div>
            <div className="text-base leading-7 text-gray-700 lg:max-w-lg">
              <p className='mt-2 text-xl font-bold tracking-tight text-gray-900 sm:text-xl'>About Us</p>
              <h1 className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
              We are dedicated to shape a brighter future.
              </h1>
            ...
            <div className="mt-10 flex">
              <a href="#" className="text-base font-semibold leading-7 text-indigo-600">
                Learn more about our Edcenta <span aria-hidden="true">&rarr;</span>
              </a>
            </div>
          </div>
        </div>
