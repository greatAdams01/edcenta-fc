              ...
              <div>
                ...
                <div>
                    ...
                    <div className='flex justify-between w-3/5'>
                        <div className='flex'>
                        <input type='radio' id='owner' name='accountType' value='' className='mr-2' /> <p>Owner</p>
                        </div>
                        <div className='flex'>
                        <input type='radio' id='tutor' name='accountType' value='' className='mr-2' /> <p>Tutor</p>
                        </div>
                        <div className='flex'>
                        <input type='radio' id='parent' name='accountType' value='' className='mr-2' /> <p>Parent</p>
                        </div>
                    </div>
                </div>
