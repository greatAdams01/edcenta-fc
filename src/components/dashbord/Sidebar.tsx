...
import { Bars3Icon, Cog6ToothIcon, XMarkIcon, ChevronRightIcon } from "@heroicons/react/24/outline"
                ...
                <Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1">
                  ...
                  <div className={`${manrope.className} flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-4`}>
                    ...
                    <nav className="flex flex-1 flex-col">
                      ...
                      {/* Quick Access */}
                      <div className="mt-6">
                        <h3 className="px-3 text-xs font-semibold text-purple-300 uppercase tracking-wider">
                          Quick Access
                        </h3>
                        <div className="mt-2 space-y-1">
                          <a
                      ...
                      <div className="mt-auto">
                        ...
                        >
                          <Cog6ToothIcon
                            className="mr-3 h-6 w-6 text-gray-400 group-hover:text-purple-600"
                            aria-hidden="true"
                          />
                          Settings
                        </Link>
          ...
          <div className="flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white">
            ...
            <nav className="flex flex-1 flex-col px-6 py-4">
              ...
              <div className="mt-auto pt-10">
                ...
                <Link
                  href="#"
                  className="mt-6 group flex items-center px-3 py-2 text-sm font-medium rounded-md text-gray-700 hover:text-purple-700 hover:bg-purple-50"
                >
